...
def makeSimulation(master, T, simu_name:str="", is_remote:bool=False, json_trace:bool=True):
    """
    """
    ...
    try:
        ...
        simuPusher = SimuPusher(simu_name) if is_remote and simu_name else PrintPusher(simu_name)
